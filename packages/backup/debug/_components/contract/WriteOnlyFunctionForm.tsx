    ...
    <div className="py-5 space-y-3 first:pt-0 last:pb-1">
      <div className={`flex gap-3 ${zeroInputs ? "flex-row justify-between items-center" : "flex-col"}`}>
        ...
        {abiFunction.stateMutability === "payable" ? (
          <div className="flex flex-col gap-1.5 w-full">
            <div className="flex items-center ml-2">
              <span className="text-xs font-medium mr-2 leading-none text-base-content">payable value</span>
              <span className="block text-xs font-extralight leading-none text-base-content/70">wei</span>
            </div>
            <IntegerInput
              value={txValue}
        ...
        <div className="flex justify-between gap-2">
          ...
          >
            <button
              className="btn bg-primary hover:bg-primary/80 text-primary-content border-none btn-sm"
