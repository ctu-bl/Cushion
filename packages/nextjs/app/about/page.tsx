  ...
  return (
    <main className="min-h-screen bg-base-200 py-12 px-4 md:px-8">
      <div className="container mx-auto">
        <h1 className="text-4xl font-bold mb-4 text-center text-base-content">About us</h1>
        ...
        <div className="text-center mt-16">
          <h2 className="text-3xl font-bold mb-6 text-base-content">What is Cushion?</h2>
          <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            <div className="flex flex-col items-center p-4">
              <div className="w-12 h-12 bg-base-content/5 rounded-full flex items-center justify-center mb-3">
...
function AboutCard({ item, isOpen, onToggle }: { item: AboutItem; isOpen: boolean; onToggle: () => void }) {
  ...
  return (
    <div
      className="card bg-base-100 rounded-2xl border border-base-content/10 shadow-md hover:shadow-lg overflow-hidden transition-all duration-500 ease-in-out"
      ...
      <div className="card-body py-6 md:py-7">
        ...
        >
          <div className="flex items-start gap-4">
            <span className="rounded-lg bg-base-200/70 w-9 h-9 grid place-items-center shrink-0 text-base-content">
              <item.Icon className="h-5 w-5" />
            </span>
            <div className="flex-1">
              <h3 className="text-xl font-semibold leading-7 text-base-content">{item.title}</h3>
              <p className="opacity-80 text-[15px] leading-6 text-base-content/80">{item.summary}</p>
            </div>
          </div>
          <button
            type="button"
            className={`btn btn-ghost btn-circle bg-base-200/60 hover:bg-base-300 transition-transform duration-300 ease-in-out text-base-content ${
              isOpen ? "rotate-90" : ""
            }`}
        ...
        <div
          ...
          className={`transition-opacity duration-300 ease-out ${
            isOpen ? "mt-5 border-t border-base-content/10 pt-5 opacity-100" : "opacity-0"
          }`}
          aria-hidden={!isOpen}
        >
