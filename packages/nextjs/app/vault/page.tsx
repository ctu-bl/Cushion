  ...
  return (
    <main className="min-h-screen bg-base-200 py-12 px-4 md:px-8">
      <div className="container mx-auto">
        ...
        <div className="card bg-base-100 rounded-2xl border border-base-content/10 shadow-sm p-8 mb-8 min-h-[200px] flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="card bg-base-100 rounded-2xl border border-base-content/10 shadow-sm p-6">
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-4 text-base-content">Your Balance</h3>
              <div className="text-4xl font-bold text-base-content mb-2">{userBalance}</div>
          ...
          <div className="card bg-base-100 rounded-2xl border border-base-content/10 shadow-sm p-6">
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-4 text-base-content">Additional Info</h3>
        ...
        <div className="flex justify-center gap-6">
          ...
          <button
            className="btn btn-outline border-base-content/20 hover:bg-base-100 text-base-content btn-lg px-8"
