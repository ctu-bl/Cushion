    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-base-200 rounded-lg p-4">
        ...
        <div className="text-center">
          <div className="text-3xl font-bold text-primary mb-2">${formatEthPrice(currentEthPrice, priceDecimals)}</div>
    ...
    <div className="mt-4">
      ...
      <div className="flex flex-wrap gap-2">
        {[1500, 2000, 2500, 3000, 3500].map((price) => (
          <button key={price} className="btn btn-outline btn-sm" onClick={() => setNewEthPrice(price.toString())}>
            ${price}
          </button>
        ))}
      </div>
