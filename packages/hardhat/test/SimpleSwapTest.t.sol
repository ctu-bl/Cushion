 ...
 * @dev Jednoduchý test pro ověření, že swap adapter funguje
 */
contract SimpleSwapTest {
    ...
    function setUp() public {
        ...
        // Předzásob swap adapter ETH
        payable(address(swapAdapter)).transfer(10 ether);
    }
    
    function testSwapAdapterWorks() public {
        // 1. Mintni PYUSD do test kontraktu
        uint256 pyusdAmount = 1000e18; // 1000 PYUSD
        pyusd.mint(address(this), pyusdAmount);
        
        // 2. Approve swap adapter
        pyusd.approve(address(swapAdapter), pyusdAmount);
        
        // 3. Zkontroluj počáteční stavy
        uint256 initialPyusdBalance = pyusd.balanceOf(address(this));
        uint256 initialWethBalance = weth.balanceOf(address(this));
        

        // PYUSD balance: initialPyusdBalance
        // WETH balance: initialWethBalance
        ...
        // === PO SWAPU ===
        // PYUSD balance: finalPyusdBalance
        // WETH balance: finalWethBalance
        // ETH out: ethOut
        // Adapter last PYUSD in: swapAdapter.lastAmountPyUsdIn()
        // Adapter last ETH out: swapAdapter.lastEthOut()
        ...
        require(ethOut == 1 ether, "Expected 1 ETH out for 1000 PYUSD"); // 1000 * 1e15 / 1e18 = 1e18
    ...
    function testSwapRateCalculation() public {
        ...
        testAmounts[0] = 100e18;   // 100 PYUSD
        testAmounts[1] = 1000e18;  // 1000 PYUSD  
        testAmounts[2] = 5000e18;  // 5000 PYUSD
        ...
        for (uint i = 0; i < testAmounts.length; i++) {
            ...
            // Ověř výpočet
            uint256 expectedEth = (amount * 1e15) / 1e18; // 1e15 = 0.001 ETH per PYUSD
            
            // Amount: amount
            // Expected ETH: expectedEth  
            // Actual ETH: ethOut
